...
public class defineConstants {
    ...
    public static final String role_Repository = "Test_Data/Download/role_repository_template.xls";
    //Admin Credentials
    ...
    public static final int orgName_Row = 4;
    public static final int orgName_Col = 0;

    public static final int roleName_Row = 4;
    public static final int roleName_Col = 1;

    public static final int salary_Row = 4;
    public static final int salary_Col = 2;

    public static final int detail_Row = 4;

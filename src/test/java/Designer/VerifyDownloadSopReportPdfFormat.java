...
public class VerifyDownloadSopReportPdfFormat extends baseClass {

    @Test(alwaysRun = true)
    @Parameters({"processName"})
    public void verifyDownloadSOPReportPDFFormat(String processName)throws Exception {
        test = extent.createTest("Download SOP Report (PDF)",
                "User should be able to Download SOP Report in PDF format");
        ...
        designerPage.verifyDownloadSOPFormatPDFReport(processName);
    }
}
